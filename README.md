...
![alt text](https://github.com/intamixx/IntamixX/blob/main/IntamixX-screenshot.png?raw=true)
...
It provides gain sliders / switches after each outlet to act as a 3-band isolator EQ.
